...
import { ChevronLeft, Info, Thermometer, Orbit, Moon } from 'lucide-react';
        ...
        {selectedPlanet && (
          ...
          >
            <button 
              ...
              className="flex items-center gap-2 text-white/70 hover:text-white mb-8 transition-colors group bg-white/5 rounded-full px-4 py-2 hover:bg-white/10"
            >
